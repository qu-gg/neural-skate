...
parser.add_argument('-d', '--dis', action='store', type=int, default=5)
parser.add_argument('-r', '--results', action='store', type=int, default=10)
...
def training(num_steps):
    ...
    for step in range(num_steps):
        ...
        if step % 500 == 0:
            ...
            plt.imshow(result)
            plt.show()
            plt.imsave("testing/results{}/{}step.png".format(args.results, step), result)
